...
class AssignmentGeneratorTailoredSerializer {
  ...
  AssignmentGeneratorTailoredSerializer({
  ...
  factory AssignmentGeneratorTailoredSerializer.fromJson(Map<String, dynamic> json) {
    return AssignmentGeneratorTailoredSerializer(
