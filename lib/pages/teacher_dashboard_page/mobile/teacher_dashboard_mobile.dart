...
class TeacherDashboardMobile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          ...
          children: [
            DrawerHeader(
              ...
              child: Text(AppConstants.appName, style: GoogleFonts.poppins(fontSize: 24, color: Colors.white)),
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                GoRouter.of(context).go('/teacher-dashboard/subscription');
              },
            ),
          ],
        ),
      ...
      //       heroTag: null,
      //       label: const Row(children: [Icon(Icons.add), SizedBox(width: 10), Text('Add Question')]),
      //       onPressed: () => context.go('/add-question'),
      //     ),
      //     FloatingActionButton.extended(
      //       heroTag: null,
      //       label: const Row(children: [Icon(Icons.book_rounded), SizedBox(width: 10), Text('Create Assignment')]),
      //       onPressed: () {},
      //     ),
      //     FloatingActionButton.extended(
      //       heroTag: null,
      //       label: const Row(
      //         children: [Icon(Icons.business_center_rounded), SizedBox(width: 10), Text('Add Question Bank')],
      //       ),
      //       onPressed: () {},
      //     ),
      //   ],
