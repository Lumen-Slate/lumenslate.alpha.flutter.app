  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      if (_isSignUp) {
        ...
        context.read<AuthBloc>().add(
          AttemptEmailSignIn(email: _emailController.text.trim(), password: _passwordController.text),
        );
      }
    }
  }
  ...
  void _sendPasswordResetEmail() {
    if (_emailController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter your email address first'), backgroundColor: Colors.red),
      );
      return;
    }

    context.read<AuthBloc>().add(SendPasswordResetEmail(email: _emailController.text.trim()));
  }
    ...
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is AuthFailure) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Password reset email sent to ${state.email}'), backgroundColor: Colors.green),
          );
        }
      },
      child: Scaffold(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      Container(
                        ...
                        child: Icon(_isSignUp ? Icons.person_add : Icons.email, color: Colors.white, size: 32),
                      ),
                      ...
                      Text(
                        _isSignUp ? 'Join us today and get started' : 'Sign in to your account',
                        style: GoogleFonts.poppins(
                          fontSize: 16,
                        ...
                        child: ElevatedButton(
                          ...
                          child: isLoading
                              ...
                              : Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Icon(_isSignUp ? Icons.person_add : Icons.login, color: Colors.white, size: 22),
                  ...
                  // OPtion to go back and explore other sign in methods
