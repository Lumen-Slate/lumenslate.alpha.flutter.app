...
class QuestionsDesktop extends StatefulWidget {
  ...
  const QuestionsDesktop({super.key, this.bankId});
...
class QuestionsDesktopState extends State<QuestionsDesktop> {
  ...
  @override
  void initState() {
    context.read<QuestionsBloc>().add(LoadQuestions(bankId: widget.bankId));
    super.initState();
  }
                                      ...
                                      return SizedBox(
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: GoogleFonts.poppins(fontSize: 22, color: Colors.grey[600]),
                                          ),
                                        ),
                                      );
                                    }
