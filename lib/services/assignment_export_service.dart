    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 8),
          pw.Text("• Read all questions carefully before answering"),
          pw.Text("• Answer all questions to the best of your ability"),
          pw.Text("• For MCQs and MSQs, mark your answers clearly"),
          pw.Text("• For numerical questions, provide exact values"),
          pw.Text("• Write legibly for subjective questions"),
          pw.Text("• Manage your time effectively"),
        ],
      ),
    );
  }
